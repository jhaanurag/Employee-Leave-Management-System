...
content = content.replace(/showLeaveForm \? \(\s*<form\s*className="mt-6 grid gap-4 rounded-2xl border border-slate-200 bg-slate-50 p-4 md:grid-cols-2"\s*onSubmit=\{onLeaveSubmit\s*>/, 
  `{showLeaveForm ? (
            <form
...
console.log("Leave form braces fixed.");
